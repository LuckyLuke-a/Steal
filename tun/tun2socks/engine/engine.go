...
import (
	...
	"steal/tun/tun2socks/core"
	"steal/tun/tun2socks/core/device"
	"steal/tun/tun2socks/core/option"
	"steal/tun/tun2socks/dialer"
	"steal/tun/tun2socks/engine/mirror"
	"steal/tun/tun2socks/log"
	"steal/tun/tun2socks/proxy"
	"steal/tun/tun2socks/restapi"
...
func stop() (err error) {
	_engineMu.Lock()
	if runtime.GOOS != "android" && _defaultDevice != nil {
